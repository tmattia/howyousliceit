...
(function(/*! Stitch !*/) {
...
}).call(this)({"collections/stories": function(exports, require, module) {(function() {
  var Story;
  ...
  exports.Stories = (function() {
    __extends(Stories, Backbone.Collection);
    function Stories() {
      Stories.__super__.constructor.apply(this, arguments);
    }
    Stories.prototype.model = Story;
    Stories.prototype.initialize = function() {
      return this.localStorage = new Store("stories");
    };
    return Stories;
  })();
}).call(this);
}, "main": function(exports, require, module) {(function() {
  var AddStoryView, HomeView, ImportStoriesView, MainRouter, MapView, Stories;
  window.app = {};
  app.routers = {};
  app.models = {};
  app.collections = {};
...
}, "models/story": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.Story = (function() {
    __extends(Story, Backbone.Model);
    function Story() {
  ...
  exports.MainRouter = (function() {
    ...
    MainRouter.prototype.home = function() {
      ...
      return app.collections.stories.fetch();
    };
    return MainRouter;
  })();
}).call(this);
}, "templates/add_story": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<input id="add-story-title" type="text" placeholder="Story title">\n');
    }).call(this);
  ...
  (function() {
    (function() {
      __out.push('<div id="storymap-app">\n    <h1>storymapping</h1>\n</div>\n');
    }).call(this);
    
  }).call(__obj);
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/import_stories": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<textarea id="import-stories"></textarea>\n<button>Import</button>\n');
    }).call(this);
    
  }).call(__obj);
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/story": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<h2 class="title">');
      __out.push(__sanitize(this.story.title));
      __out.push('</h2>\n<input class="title" value="');
      __out.push(__sanitize(this.story.title));
      __out.push('" type="text">\n<h3 class="user">');
      __out.push(__sanitize(this.story.user));
      __out.push('</h3>\n<input class="user" value="');
      __out.push(__sanitize(this.story.user));
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/add_story_view": function(exports, require, module) {(function() {
  var addStoryTemplate;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.AddStoryView = (function() {
    __extends(AddStoryView, Backbone.View);
    function AddStoryView() {
      AddStoryView.__super__.constructor.apply(this, arguments);
    }
    AddStoryView.prototype.id = 'add-story';
    AddStoryView.prototype.events = {
      'keypress #add-story-title': 'addStory'
    };
    AddStoryView.prototype.render = function() {
      $(this.el).html(addStoryTemplate());
      return this;
    };
    AddStoryView.prototype.addStory = function(event) {
      if (event.keyCode !== $.ui.keyCode.ENTER) {
        return;
      }
      app.collections.stories.create({
        title: $('#add-story-title').val()
      });
      return $('#add-story-title').val('');
    };
    return AddStoryView;
  })();
}).call(this);
}, "views/home_view": function(exports, require, module) {(function() {
  var Story, homeTemplate;
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.HomeView = (function() {
    ...
    HomeView.prototype.render = function() {
      ...
      $(this.el).find('#storymap-app').append(app.views.addStory.render().el);
      $(this.el).find('#storymap-app').append(app.views.map.render().el);
      return this;
    };
    return HomeView;
  })();
}).call(this);
}, "views/import_stories_view": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.ImportStoriesView = (function() {
    __extends(ImportStoriesView, Backbone.View);
    function ImportStoriesView() {
      ImportStoriesView.__super__.constructor.apply(this, arguments);
    }
    ImportStoriesView.prototype.id = 'import-stories';
    return ImportStoriesView;
  })();
}).call(this);
  ...
  exports.MapView = (function() {
    ...
    MapView.prototype.initialize = function() {
      app.collections.stories.bind('add', this.addOne);
      return app.collections.stories.bind('reset', this.addAll);
    };
    MapView.prototype.addOne = function(story) {
      var view;
      view = new StoryView({
        model: story
      });
    ...
    MapView.prototype.addAll = function() {
      return app.collections.stories.each(app.views.map.addOne);
    };
    return MapView;
  })();
}).call(this);
}, "views/story_view": function(exports, require, module) {(function() {
  var storyTemplate;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
  ...
  exports.StoryView = (function() {
    __extends(StoryView, Backbone.View);
    function StoryView() {
      this.remove = __bind(this.remove, this);
      this.save = __bind(this.save, this);
      this.edit = __bind(this.edit, this);
      this.render = __bind(this.render, this);
      StoryView.__super__.constructor.apply(this, arguments);
    }
    ...
    StoryView.prototype.render = function() {
      ...
      if (frequency >= 5) {
        $(this.el).find('.frequency .highest').addClass('checked');
      }
      if (frequency >= 4) {
        $(this.el).find('.frequency .high').addClass('checked');
      }
      if (frequency >= 3) {
        $(this.el).find('.frequency .medium').addClass('checked');
      }
      if (frequency >= 2) {
        $(this.el).find('.frequency .low').addClass('checked');
      }
      if (frequency >= 1) {
        $(this.el).find('.frequency .lowest').addClass('checked');
      }
      if (value >= 3) {
        $(this.el).find('.value .high').addClass('checked');
      }
      if (value >= 2) {
        $(this.el).find('.value .medium').addClass('checked');
      }
      if (value >= 1) {
        $(this.el).find('.value .low').addClass('checked');
      }
      return this;
    };
    StoryView.prototype.edit = function(event) {
      $(this.el).addClass('editing');
      return $(this.el).find('input.title').focus();
    };
    StoryView.prototype.save = function(event) {
      if (event.keyCode !== $.ui.keyCode.ENTER) {
        return;
      }
      this.model.save({
        title: $(this.el).find('input.title').val(),
        user: $(this.el).find('input.user').val()
      });
      return $(this.el).removeClass('editing');
    };
    StoryView.prototype.remove = function(event) {
      this.model.destroy();
